          ...
          {[
            {
              ...
              image: "https://picsum.photos/seed/tools-dashboard/1200/800",
              icon: Zap,
              tag: "Dashboard"
            },
            {
              ...
              image: "https://picsum.photos/seed/code-workspace/1200/800",
              icon: Code2,
              tag: "Workspace"
            },
            {
              ...
              image: "https://picsum.photos/seed/web-navigation/1200/800",
              icon: ArrowRight,
              tag: "Navigation"
            }
          ].map((step, i) => (
